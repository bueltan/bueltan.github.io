...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1342: (x0,x1,x2) => x0.open(x1,x2),
      _1343: () => new XMLHttpRequest(),
      _1344: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1345: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1346: (x0,x1) => x0.send(x1),
      _1347: x0 => x0.abort(),
      _1348: x0 => x0.getAllResponseHeaders(),
      _1361: Date.now,
      ...
      _1399: Object.is,
      _1400: o => o instanceof Array,
      _1401: (a, i) => a.push(i),
      _1405: a => a.pop(),
      _1406: (a, i) => a.splice(i, 1),
      _1407: (a, s) => a.join(s),
      _1408: (a, s, e) => a.slice(s, e),
      _1410: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1411: a => a.length,
      _1413: (a, i) => a[i],
      _1414: (a, i, v) => a[i] = v,
      _1416: o => {
      ...
      _1417: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1419: o => o instanceof Uint8Array,
      _1420: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1421: o => o instanceof Int8Array,
      _1422: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1423: o => o instanceof Uint8ClampedArray,
      _1424: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1425: o => o instanceof Uint16Array,
      _1426: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1427: o => o instanceof Int16Array,
      _1428: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1429: o => o instanceof Uint32Array,
      _1430: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1431: o => o instanceof Int32Array,
      _1432: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1434: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1435: o => o instanceof Float32Array,
      _1436: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1437: o => o instanceof Float64Array,
      _1438: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1439: (t, s) => t.set(s),
      _1441: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1443: o => o.buffer,
      _1444: o => o.byteOffset,
      _1445: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1446: (b, o) => new DataView(b, o),
      _1447: (b, o, l) => new DataView(b, o, l),
      _1448: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1449: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1450: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1451: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1452: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1453: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1454: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1455: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1456: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1457: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1458: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1459: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1462: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1463: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1464: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1465: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1466: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1467: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1480: (ms, c) =>
      ...
      _1519: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1519(f,arguments.length,x0,x1) }),
      _1520: o => {
      ...
      _1557: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1558: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1563: x0 => x0.random(),
      ...
      _1673: (x0,x1) => { x0.withCredentials = x1 },
      _1675: x0 => x0.responseURL,
      _1676: x0 => x0.status,
      _1677: x0 => x0.statusText,
      _1679: (x0,x1) => { x0.responseType = x1 },
      _1680: x0 => x0.response,
      _3463: () => globalThis.window,
      _3507: x0 => x0.location,
      _3526: x0 => x0.navigator,
      _3805: x0 => x0.hostname,
      _3847: (x0,x1) => { x0.returnValue = x1 },
      _3902: x0 => x0.maxTouchPoints,
      _3912: x0 => x0.platform,
